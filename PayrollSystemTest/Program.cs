...
var salariedEmployee = new SalariedEmployee("Juan", "Sánchez",   "111-11-1111", 800.00M);

var hourlyEmployee = new HourlyEmployee("Karen", "Pérez", "222-22-2222",16.75M, 40.0M);

var commissionEmployee = new CommissionEmployee("Susana", "Jiménez", "333-33-3333", 10000.00M, .06M);

var basePlusComissionEmployee = new BasePlusCommissionEmployee("Roberto",  "López", "444-44-4444", 5000.00M, .04M, 300.00M);
...
Console.WriteLine($"{basePlusComissionEmployee}\nearned: " + $"{basePlusComissionEmployee.Earnings():C}\n");
